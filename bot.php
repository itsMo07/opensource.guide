      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/QGQQGO",
                   'caption'=>'تمت البرمجه بوسطة(@Corona_virus_numbers_bot)🤩💵',
...
لمراسله المطور- @Corona_virus_numbers_bot",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                       ...
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/tuka6"]],
                      ]
                  ])
              ]);   
				}
